...
public class ColorPicker extends View {
    ...
    private void init(Context context) {
        ...
        mThumbRadius = DimensionUtils.dpToFloatPx(12, displayMetrics);
        mHeight = (int) (mThumbRadius * 4 + DimensionUtils.dpToFloatPx(17, displayMetrics) + 0.5);
        mBarHeight = DimensionUtils.dpToFloatPx(4, displayMetrics);
